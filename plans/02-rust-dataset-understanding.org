...
:PROPERTIES:
:CUSTOM_ID: rust-dataset-understanding-for-vela
:END:
** Purpose
:PROPERTIES:
:CUSTOM_ID: purpose
...
:PROPERTIES:
:CUSTOM_ID: important-principle-do-not-trust-dataset-labels-blindly
:END:
...
:PROPERTIES:
:CUSTOM_ID: dataset-convencerust-coder
:END:
Verified path:
...
:PROPERTIES:
:CUSTOM_ID: dataset-gubernacrust-coder
:END:
Verified path:
...
:PROPERTIES:
:CUSTOM_ID: dataset-introspectorrust-analyser
:END:
Verified path:
...
:PROPERTIES:
:CUSTOM_ID: dataset-fortytwo-networkstrandset-rust-v1
:END:
Verified path:
...
:PROPERTIES:
:CUSTOM_ID: vela-subsystem-proposal-rust-coding-mentor
:END:
...
:PROPERTIES:
:CUSTOM_ID: vela-dataset-ingestion-plan
:END:
Before relying on these datasets, build a local inspection tool. The broader rewrite/combine strategy is defined in [[./03-rust-corpus-strategy.org][=03-rust-corpus-strategy.org=]].
...
:PROPERTIES:
:CUSTOM_ID: how-this-shapes-vela
:END:
