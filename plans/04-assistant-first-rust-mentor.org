...
:PROPERTIES:
:CUSTOM_ID: assistant-first-rust-mentor-plan
:END:
** Correction
:PROPERTIES:
...
:PROPERTIES:
:CUSTOM_ID: 2-retrieve-relevant-corpus-examples
:END:
...
:PROPERTIES:
:CUSTOM_ID: 3-draft-implementation
:END:
...
:PROPERTIES:
:CUSTOM_ID: 4-run-deterministic-checks
:END:
...
:PROPERTIES:
:CUSTOM_ID: 5-compare-against-corpus-and-local-style
:END:
Ask:
...
*** 6. Improve the patch
:PROPERTIES:
:CUSTOM_ID: 6-improve-the-patch
:END:
Use compiler/test/corpus feedback to revise.

*** 7. Feed lessons back
:PROPERTIES:
:CUSTOM_ID: 7-feed-lessons-back
:END:
...
:PROPERTIES:
:CUSTOM_ID: assistant-corpus-creation-responsibilities
:END:
...
:PROPERTIES:
:CUSTOM_ID: first-usable-version
:END:
...
:PROPERTIES:
:CUSTOM_ID: corpus-quality-labels-for-assistant-use
:END:
...
:PROPERTIES:
:CUSTOM_ID: how-the-assistant-uses-it-to-perfect-it
:END:
...
:PROPERTIES:
:CUSTOM_ID: milestone-f--feedback-loop
:END:
...
:PROPERTIES:
:CUSTOM_ID: relationship-to-vela
:END:
