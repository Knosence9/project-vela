...
:PROPERTIES:
:CUSTOM_ID: project-vela-architecture-research-notes
:END:
** Research question
:PROPERTIES:
...
:PROPERTIES:
:CUSTOM_ID: rust-ecosystem-candidates
:END:
*** Runtime and orchestration
:PROPERTIES:
:CUSTOM_ID: runtime-and-orchestration
:END:
...
:PROPERTIES:
:CUSTOM_ID: agent-frameworks-to-study
:END:
...
:PROPERTIES:
:CUSTOM_ID: tooling-and-integration
:END:
- =clap=: CLI surface.
...
:PROPERTIES:
:CUSTOM_ID: local-model--rust-ml-candidates
:END:
...
:PROPERTIES:
:CUSTOM_ID: rust-learningcode-datasets-mentioned
:END:
...
Detailed dataset notes live in [[./02-rust-dataset-understanding.org][=02-rust-dataset-understanding.org=]]. The most important conclusion is that Vela must use dataset quality gates: compile checks, semantic alignment checks, license/provenance tracking, and stricter review for unsafe/FFI/concurrency examples.
...
:PROPERTIES:
:CUSTOM_ID: convencerust-coder--gubernacrust-coder
:END:
...
:PROPERTIES:
:CUSTOM_ID: vela-specific-design-implications
:END:
*** 1. Vela needs a kernel, not just agents
:PROPERTIES:
:CUSTOM_ID: 1-vela-needs-a-kernel-not-just-agents
:END:
...
:PROPERTIES:
:CUSTOM_ID: 2-skillsworkflowsextensions-need-shared-dependencies
:END:
...
:PROPERTIES:
:CUSTOM_ID: 3-self-improvement-must-be-explicit-and-auditable
:END:
...
:PROPERTIES:
:CUSTOM_ID: 4-the-model-should-not-do-deterministic-bookkeeping
:END:
...
:PROPERTIES:
:CUSTOM_ID: 5-tone-adaptation-needs-conflict-detection
:END:
...
:PROPERTIES:
:CUSTOM_ID: open-architecture-decisions
:END:
...
:PROPERTIES:
:CUSTOM_ID: tentative-recommendation
:END:
