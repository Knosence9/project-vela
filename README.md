...
7. Start the persisted task lifecycle with durable start, completion, and load. ✅
...
- [`docs/task-lifecycle.md`](docs/task-lifecycle.md) — persisted task start/completion/load behavior
