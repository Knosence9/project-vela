...
:PROPERTIES:
:CUSTOM_ID: durable-task-schedules-and-finite-recurrence-definitions
:END:
...
:PROPERTIES:
:CUSTOM_ID: writable-cli-creation
:END:
...
:PROPERTIES:
:CUSTOM_ID: writable-cli-cancellation
:END:
...
:PROPERTIES:
:CUSTOM_ID: writable-cli-claiming
:END:
...
:PROPERTIES:
:CUSTOM_ID: writable-cli-release
:END:
...
:PROPERTIES:
:CUSTOM_ID: writable-cli-materialization
:END:
...
:PROPERTIES:
:CUSTOM_ID: writable-cli-next-due-claiming
:END:
...
:PROPERTIES:
:CUSTOM_ID: writable-cli-next-due-materialization
:END:
...
:PROPERTIES:
:CUSTOM_ID: writable-recurrence-cli-creation
:END:
=vela-dev recurrence create DATABASE RECURRENCE_ID GOAL ANCHOR_UNIX_MILLIS INTERVAL_MILLIS OCCURRENCE_COUNT= validates the exact caller-owned recurrence ID,
...
[[file:adr/0042-writable-finite-recurrence-cli-creation.org][ADR-0042]].

** Writable recurrence cancellation CLI
:PROPERTIES:
:CUSTOM_ID: writable-recurrence-cancellation-cli
:END:
...
[[file:adr/0083-writable-finite-recurrence-cancellation-cli.org][ADR-0083]].

** Read-only exact recurrence CLI lookup
:PROPERTIES:
:CUSTOM_ID: read-only-exact-recurrence-cli-lookup
:END:
...
[[file:adr/0043-read-only-exact-finite-recurrence-cli-lookup.org][ADR-0043]].
...
state from
[[file:adr/0082-recurrence-cancellation-with-definition-revision-separation.org][ADR-0082]].

** Read-only exact recurrence history CLI
:PROPERTIES:
:CUSTOM_ID: read-only-exact-recurrence-history-cli
:END:
...
See [[file:adr/0084-read-only-exact-finite-recurrence-history.org][ADR-0084]].

** Read-only exact recurrence occurrence history CLI
:PROPERTIES:
:CUSTOM_ID: read-only-exact-recurrence-occurrence-history-cli
:END:
...
authority. See
[[file:adr/0086-read-only-exact-recurrence-occurrence-history-cli.org][ADR-0086]].

** Read-only bounded recurrence occurrence history CLI paging
:PROPERTIES:
:CUSTOM_ID: read-only-bounded-recurrence-occurrence-history-cli-paging
:END:
=vela-dev recurrence occurrence-histories DATABASE RECURRENCE_ID START_OFFSET PAGE_SIZE= validates the exact recurrence ID and positive, at-most-1024 page size
...
[[file:adr/0088-read-only-bounded-recurrence-occurrence-history-cli-paging.org][ADR-0088]].

** Read-only exact recurrence occurrence CLI paging
:PROPERTIES:
:CUSTOM_ID: read-only-exact-recurrence-occurrence-cli-paging
:END:
...
or execute work. See
[[file:adr/0044-read-only-exact-finite-recurrence-occurrence-cli-paging.org][ADR-0044]].

** Read-only due recurrence occurrence CLI paging
:PROPERTIES:
:CUSTOM_ID: read-only-due-recurrence-occurrence-cli-paging
:END:
=vela-dev recurrence due DATABASE RECURRENCE_ID START_OFFSET PAGE_SIZE CUTOFF_UNIX_MILLIS= validates the exact recurrence ID and positive, at-most-1024
...
[[file:adr/0057-read-only-due-recurrence-occurrence-cli-paging.org][ADR-0057]].

** Read-only latest-due recurrence occurrence CLI selection
:PROPERTIES:
:CUSTOM_ID: read-only-latest-due-recurrence-occurrence-cli-selection
:END:
=vela-dev recurrence latest-due DATABASE RECURRENCE_ID START_OFFSET CUTOFF_UNIX_MILLIS= validates the exact recurrence ID before storage access;
...
[[file:adr/0061-read-only-latest-due-recurrence-cli.org][ADR-0061]].

** Writable atomic latest-due recurrence occurrence CLI persistence
:PROPERTIES:
:CUSTOM_ID: writable-atomic-latest-due-recurrence-occurrence-cli-persistence
:END:
=vela-dev recurrence persist-latest-due DATABASE RECURRENCE_ID EXPECTED_REVISION START_OFFSET CUTOFF_UNIX_MILLIS= validates the exact
...
[[file:adr/0063-writable-atomic-latest-due-recurrence-cli.org][ADR-0063]].

** Writable atomic latest-due recurrence task materialization CLI
:PROPERTIES:
:CUSTOM_ID: writable-atomic-latest-due-recurrence-task-materialization-cli
:END:
=vela-dev recurrence materialize-latest-due DATABASE RECURRENCE_ID EXPECTED_REVISION START_OFFSET CUTOFF_UNIX_MILLIS TASK_ID= validates both exact
...
execution authority. See
[[file:adr/0065-writable-atomic-latest-due-recurrence-task-materialization-cli.org][ADR-0065]].

** Writable atomic due recurrence occurrence CLI paging
:PROPERTIES:
:CUSTOM_ID: writable-atomic-due-recurrence-occurrence-cli-paging
:END:
=vela-dev recurrence persist-due DATABASE RECURRENCE_ID EXPECTED_REVISION START_OFFSET PAGE_SIZE CUTOFF_UNIX_MILLIS= validates the exact recurrence ID and
...
authority. See
[[file:adr/0059-writable-atomic-due-recurrence-page-cli.org][ADR-0059]].

** Writable atomic due recurrence task materialization CLI
:PROPERTIES:
:CUSTOM_ID: writable-atomic-due-recurrence-task-materialization-cli
:END:
=vela-dev recurrence materialize-due DATABASE RECURRENCE_ID EXPECTED_REVISION START_OFFSET PAGE_SIZE CUTOFF_UNIX_MILLIS [TASK_IDS]...= validates the exact
...
See [[file:adr/0067-writable-atomic-due-recurrence-task-materialization-cli.org][ADR-0067]].

** Writable exact recurrence occurrence provenance CLI
:PROPERTIES:
:CUSTOM_ID: writable-exact-recurrence-occurrence-provenance-cli
:END:
...
[[file:adr/0046-writable-exact-recurrence-occurrence-provenance-cli.org][ADR-0046]].

** Writable exact recurrence occurrence claim CLI
:PROPERTIES:
:CUSTOM_ID: writable-exact-recurrence-occurrence-claim-cli
:END:
=vela-dev recurrence claim DATABASE RECURRENCE_ID OFFSET EXPECTED_OCCURRENCE_REVISION CUTOFF_UNIX_MILLIS= validates the exact recurrence
...
[[file:adr/0070-writable-exact-recurrence-occurrence-claim-cli.org][ADR-0070]].

** Writable exact recurrence occurrence release CLI
:PROPERTIES:
:CUSTOM_ID: writable-exact-recurrence-occurrence-release-cli
:END:
=vela-dev recurrence release DATABASE RECURRENCE_ID OFFSET EXPECTED_OCCURRENCE_REVISION REASON= validates the exact recurrence ID and one
...
See [[file:adr/0071-writable-exact-recurrence-occurrence-release-cli.org][ADR-0071]].

** Writable exact recurrence occurrence materialization CLI
:PROPERTIES:
:CUSTOM_ID: writable-exact-recurrence-occurrence-materialization-cli
:END:
=vela-dev recurrence materialize DATABASE RECURRENCE_ID OFFSET EXPECTED_OCCURRENCE_REVISION TASK_ID= validates both exact caller-owned
...
[[file:adr/0051-writable-exact-recurrence-occurrence-task-materialization-cli.org][ADR-0051]].

** Writable exact claimed recurrence occurrence materialization CLI
:PROPERTIES:
:CUSTOM_ID: writable-exact-claimed-recurrence-occurrence-materialization-cli
:END:
=vela-dev recurrence materialize-claimed DATABASE RECURRENCE_ID OFFSET EXPECTED_OCCURRENCE_REVISION TASK_ID= validates both exact caller-owned
...
[[file:adr/0073-writable-exact-claimed-recurrence-occurrence-materialization-cli.org][ADR-0073]].

** Read-only exact persisted recurrence occurrence CLI lookup
:PROPERTIES:
:CUSTOM_ID: read-only-exact-persisted-recurrence-occurrence-cli-lookup
:END:
...
See [[file:adr/0047-read-only-exact-persisted-recurrence-occurrence-cli.org][ADR-0047]].

** Read-only persisted recurrence occurrence CLI paging
:PROPERTIES:
:CUSTOM_ID: read-only-persisted-recurrence-occurrence-cli-paging
:END:
...
[[file:adr/0049-read-only-persisted-recurrence-occurrence-cli-paging.org][ADR-0049]].

** Read-only claimed recurrence occurrence CLI paging
:PROPERTIES:
:CUSTOM_ID: read-only-claimed-recurrence-occurrence-cli-paging
:END:
...
authority. See
[[file:adr/0075-read-only-claimed-recurrence-occurrence-cli-paging.org][ADR-0075]].

** Read-only available recurrence occurrence CLI paging
:PROPERTIES:
:CUSTOM_ID: read-only-available-recurrence-occurrence-cli-paging
:END:
...
lease, dispatch, workflow, provider/tool, permission, retry, or execution
authority. See
[[file:adr/0077-read-only-available-recurrence-occurrence-cli-paging.org][ADR-0077]].

** Writable bounded recurrence claim-next CLI
:PROPERTIES:
:CUSTOM_ID: writable-bounded-recurrence-claim-next-cli
:END:
=vela-dev recurrence claim-next DATABASE RECURRENCE_ID START_OFFSET PAGE_SIZE CUTOFF_UNIX_MILLIS= validates the exact recurrence ID and positive,
...
authority. See
[[file:adr/0079-writable-bounded-recurrence-claim-next-cli.org][ADR-0079]].

** Writable bounded recurrence materialize-next CLI
:PROPERTIES:
:CUSTOM_ID: writable-bounded-recurrence-materialize-next-cli
:END:
=vela-dev recurrence materialize-next DATABASE RECURRENCE_ID START_OFFSET PAGE_SIZE CUTOFF_UNIX_MILLIS TASK_ID= validates the exact recurrence ID,
...
provider/tool, workflow, or execution authority. See
[[file:adr/0081-writable-bounded-recurrence-materialize-next-cli.org][ADR-0081]].

** Read-only materialized recurrence occurrence CLI paging
:PROPERTIES:
:CUSTOM_ID: read-only-materialized-recurrence-occurrence-cli-paging
:END:
...
claim, dispatch, workflow, provider/tool, permission, retry, or execution
authority. See
[[file:adr/0055-read-only-materialized-recurrence-occurrence-cli-paging.org][ADR-0055]].

** Read-only recurrence task-provenance CLI
:PROPERTIES:
:CUSTOM_ID: read-only-recurrence-task-provenance-cli
:END:
...
dispatch, workflow, provider/tool, permission, retry, or execution authority.
See [[file:adr/0053-read-only-recurrence-task-provenance-cli.org][ADR-0053]].

** Read-only recurrence CLI inventory
:PROPERTIES:
:CUSTOM_ID: read-only-recurrence-cli-inventory
:END:
...
[[file:adr/0041-read-only-finite-recurrence-cli-inventory.org][ADR-0041]].

** Read-only bounded recurrence CLI inventory paging
:PROPERTIES:
:CUSTOM_ID: read-only-bounded-recurrence-cli-inventory-paging
:END:
...
[[file:adr/0092-read-only-bounded-finite-recurrence-inventory-cli-paging.org][ADR-0092]].

** Read-only recurrence status CLI filtering
:PROPERTIES:
:CUSTOM_ID: read-only-recurrence-status-cli-filtering
:END:
...
[[file:adr/0090-read-only-finite-recurrence-status-cli-filtering.org][ADR-0090]].

** Read-only bounded sparse recurrence status CLI paging
:PROPERTIES:
:CUSTOM_ID: read-only-bounded-sparse-recurrence-status-cli-paging
:END:
...
[[file:adr/0098-read-only-bounded-sparse-finite-recurrence-status-cli-paging.org][ADR-0098]].

** Read-only CLI inspection
:PROPERTIES:
:CUSTOM_ID: read-only-cli-inspection
:END:
...
:PROPERTIES:
:CUSTOM_ID: read-only-bounded-schedule-cli-inventory-paging
:END:
...
[[file:adr/0094-read-only-bounded-one-shot-schedule-inventory-cli-paging.org][ADR-0094]].
...
:PROPERTIES:
:CUSTOM_ID: read-only-bounded-sparse-schedule-due-cli-paging
:END:
...
execution authority. See
[[file:adr/0100-read-only-bounded-sparse-one-shot-schedule-due-cli-paging.org][ADR-0100]].
...
:PROPERTIES:
:CUSTOM_ID: read-only-bounded-sparse-schedule-status-cli-paging
:END:
...
dispatch, retry, permission, or execution authority. See
[[file:adr/0096-read-only-bounded-sparse-one-shot-schedule-status-cli-paging.org][ADR-0096]].
