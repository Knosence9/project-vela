...
:PROPERTIES:
:CUSTOM_ID: adr-0056-caller-cutoff-finite-recurrence-due-paging
:END:
- *Status:* accepted
- *Date:* 2026-08-04
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/903][#903]]
...
:PROPERTIES:
:CUSTOM_ID: filter-a-normal-occurrence-page-after-projection
:END:
...
:PROPERTIES:
:CUSTOM_ID: return-no-cursor-when-nothing-is-currently-due
:END:
...
:PROPERTIES:
:CUSTOM_ID: read-the-system-clock-in-the-store
:END:
