...
:PROPERTIES:
:CUSTOM_ID: adr-0091-bounded-finite-recurrence-inventory-paging
:END:
- *Status:* accepted
- *Date:* 2026-08-07
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/983][#983]]
...
:PROPERTIES:
:CUSTOM_ID: slice-recurrencestorelist-in-memory
:END:
...
:PROPERTIES:
:CUSTOM_ID: combine-status-filtering-and-paging
:END:
