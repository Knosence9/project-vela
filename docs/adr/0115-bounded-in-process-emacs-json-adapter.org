...
:PROPERTIES:
:CUSTOM_ID: adr-0115-bounded-in-process-emacs-json-adapter
:END:
- *Status:* accepted
- *Date:* 2026-08-09
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/1043][#1043]]
...
:PROPERTIES:
:CUSTOM_ID: add-json-rpc-and-a-local-socket-now
:END:
...
:PROPERTIES:
:CUSTOM_ID: use-json-parse-string-with-hash-table-objects
:END:
...
:PROPERTIES:
:CUSTOM_ID: accept-the-first-json-value-and-ignore-trailing-input
:END:
...
:PROPERTIES:
:CUSTOM_ID: expose-parser-errors-directly
:END:
