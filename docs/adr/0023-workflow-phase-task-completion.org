...
:PROPERTIES:
:CUSTOM_ID: adr-0023-preserve-explicit-workflow-phase-final-responses-as-task-completion-output
:END:
- *Status:* accepted
- *Date:* 2026-07-30
- *Decision issue:* [[https://github.com/Knosence9/project-vela/issues/753][#753]]
- *Execution issue:* [[https://github.com/Knosence9/project-vela/issues/754][#754]]
...
:PROPERTIES:
:CUSTOM_ID: treat-a-successful-provider-response-as-verification
:END:
...
:PROPERTIES:
:CUSTOM_ID: complete-the-attributed-workflow-run-with-the-task
:END:
...
:PROPERTIES:
:CUSTOM_ID: complete-atomically-with-the-assistant-turn-and-attempt
:END:
