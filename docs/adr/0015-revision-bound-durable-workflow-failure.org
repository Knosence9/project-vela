...
:PROPERTIES:
:CUSTOM_ID: adr-0015-fail-durable-workflow-runs-with-revision-bound-diagnostics
:END:
- *Status:* accepted
- *Date:* 2026-07-28
...
:PROPERTIES:
:CUSTOM_ID: encode-failure-as-cancellation
:END:
...
:PROPERTIES:
:CUSTOM_ID: add-a-synthetic-failure-phase
:END:
...
:PROPERTIES:
:CUSTOM_ID: automatically-fail-on-provider-or-tool-errors
:END:
...
:PROPERTIES:
:CUSTOM_ID: clear-pause-state-when-failing
:END:
