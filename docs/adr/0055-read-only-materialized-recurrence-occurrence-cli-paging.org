...
:PROPERTIES:
:CUSTOM_ID: adr-0055-read-only-materialized-recurrence-occurrence-cli-paging
:END:
- *Status:* accepted
- *Date:* 2026-08-03
...
:PROPERTIES:
:CUSTOM_ID: filter-all-materialization-events-in-the-cli
:END:
...
:PROPERTIES:
:CUSTOM_ID: add-global-materialized-binding-inventory
:END:
