...
:PROPERTIES:
:CUSTOM_ID: adr-0075-read-only-claimed-recurrence-occurrence-cli-paging
:END:
- *Status:* accepted
- *Date:* 2026-08-05
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/945][#945]]
...
:PROPERTIES:
:CUSTOM_ID: filter-claim-events-in-the-cli
:END:
...
:PROPERTIES:
:CUSTOM_ID: return-every-occurrence-lifecycle-with-a-status
:END:
...
:PROPERTIES:
:CUSTOM_ID: add-global-claimed-occurrence-inventory
:END:
