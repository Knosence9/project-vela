...
:PROPERTIES:
:CUSTOM_ID: adr-0039-bounded-finite-recurrence-occurrence-paging
:END:
- *Status:* accepted
- *Date:* 2026-08-02
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/863][#863]]
...
:PROPERTIES:
:CUSTOM_ID: return-all-remaining-occurrences
:END:
...
:PROPERTIES:
:CUSTOM_ID: treat-a-start-at-the-finite-end-as-an-empty-page
:END:
...
:PROPERTIES:
:CUSTOM_ID: expose-an-unbounded-lazy-iterator
:END:
...
:PROPERTIES:
:CUSTOM_ID: persist-the-page-cursor
:END:
