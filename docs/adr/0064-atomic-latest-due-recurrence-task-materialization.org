...
:PROPERTIES:
:CUSTOM_ID: adr-0064-atomic-latest-due-recurrence-task-materialization
:END:
- *Status:* accepted
- *Date:* 2026-08-05
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/921][#921]]
...
:PROPERTIES:
:CUSTOM_ID: persist-latest-due-then-materialize-exact-occurrence
:END:
...
:PROPERTIES:
:CUSTOM_ID: materialize-an-unpersisted-projection-without-occurrence-provenance
:END:
...
:PROPERTIES:
:CUSTOM_ID: consume-an-already-persisted-selected-occurrence
:END:
...
:PROPERTIES:
:CUSTOM_ID: generate-a-task-identity-or-read-the-clock
:END:
