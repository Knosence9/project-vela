...
:PROPERTIES:
:CUSTOM_ID: adr-0028-persist-typed-independent-task-verification-outcomes
:END:
- *Status:* accepted
- *Date:* 2026-07-30
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/769][#769]]
...
:PROPERTIES:
:CUSTOM_ID: encode-passfail-into-the-evidence-text
:END:
...
:PROPERTIES:
:CUSTOM_ID: require-every-historical-and-generic-verification-to-have-an-outcome
:END:
...
:PROPERTIES:
:CUSTOM_ID: derive-task-completion-from-a-passing-result
:END:
