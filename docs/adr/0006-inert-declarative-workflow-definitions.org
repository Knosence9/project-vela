...
:PROPERTIES:
:CUSTOM_ID: adr-0006-validate-workflows-as-inert-declarative-state-machines
:END:
- *Status:* accepted
- *Date:* 2026-07-28
- *Owners:* Project Vela maintainers
- *Related issue:* [[https://github.com/Knosence9/project-vela/issues/676][#676]]
- *First execution issue:* [[https://github.com/Knosence9/project-vela/issues/677][#677]]
...
:PROPERTIES:
:CUSTOM_ID: treat-workflow-entrypoints-as-skill-instructions
:END:
...
:PROPERTIES:
:CUSTOM_ID: execute-workflow-entrypoints-as-webassembly-tools
:END:
...
:PROPERTIES:
:CUSTOM_ID: define-an-executor-and-persistence-model-immediately
:END:
...
:PROPERTIES:
:CUSTOM_ID: permit-unreachable-phases-or-implicit-terminal-phases
:END:
