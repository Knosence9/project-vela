...
:PROPERTIES:
:CUSTOM_ID: adr-0102-read-only-bounded-one-shot-schedule-history-cli-paging
:END:
- *Status:* accepted
- *Date:* 2026-08-08
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/1009][#1009]]
