...
:PROPERTIES:
:CUSTOM_ID: adr-0067-writable-atomic-due-recurrence-task-materialization-cli
:END:
- *Status:* accepted
- *Date:* 2026-08-05
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/927][#927]]
...
:PROPERTIES:
:CUSTOM_ID: persist-the-due-page-then-materialize-each-coordinate
:END:
...
:PROPERTIES:
:CUSTOM_ID: generate-task-identities-in-the-cli
:END:
...
:PROPERTIES:
:CUSTOM_ID: require-at-least-one-task-identity-syntactically
:END:
