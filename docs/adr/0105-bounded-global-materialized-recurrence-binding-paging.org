...
:PROPERTIES:
:CUSTOM_ID: adr-0105-bounded-global-materialized-recurrence-binding-paging
:END:
- *Status:* accepted
- *Date:* 2026-08-08
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/1017][#1017]]
...
:PROPERTIES:
:CUSTOM_ID: order-by-recurrence-id-and-numeric-offset-extracted-from-json
:END:
...
:PROPERTIES:
:CUSTOM_ID: expose-raw-stream-ids-as-cursors
:END:
...
:PROPERTIES:
:CUSTOM_ID: page-every-recurrence-and-authored-offset
:END:
...
:PROPERTIES:
:CUSTOM_ID: claim-global-task-identity-uniqueness-while-paging
:END:
