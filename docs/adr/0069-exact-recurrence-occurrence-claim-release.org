...
:PROPERTIES:
:CUSTOM_ID: adr-0069-exact-recurrence-occurrence-claim-release
:END:
- *Status:* accepted
- *Date:* 2026-08-05
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/933][#933]]
...
:PROPERTIES:
:CUSTOM_ID: infer-release-after-elapsed-time
:END:
...
:PROPERTIES:
:CUSTOM_ID: keep-released-coordinates-in-a-terminal-recovery-state
:END:
...
:PROPERTIES:
:CUSTOM_ID: add-claim-next-or-claimed-inventory
:END:
...
:PROPERTIES:
:CUSTOM_ID: materialize-directly-from-claimed-state-in-the-same-slice
:END:
