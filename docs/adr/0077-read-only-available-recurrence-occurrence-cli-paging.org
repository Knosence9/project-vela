...
:PROPERTIES:
:CUSTOM_ID: adr-0077-read-only-available-recurrence-occurrence-cli-paging
:END:
- *Status:* accepted
- *Date:* 2026-08-05
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/949][#949]]
...
:PROPERTIES:
:CUSTOM_ID: derive-availability-from-persisted-cli-output
:END:
...
:PROPERTIES:
:CUSTOM_ID: return-a-generic-lifecycle-status-page
:END:
...
:PROPERTIES:
:CUSTOM_ID: add-global-available-occurrence-inventory
:END:
