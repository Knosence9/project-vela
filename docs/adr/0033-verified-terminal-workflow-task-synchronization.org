...
:PROPERTIES:
:CUSTOM_ID: adr-0033-verified-terminal-workflowtask-synchronization
:END:
- *Status:* accepted
- *Date:* 2026-07-30
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/781][#781]]
...
:PROPERTIES:
:CUSTOM_ID: call-verified-advancement-and-verified-completion-sequentially
:END:
...
:PROPERTIES:
:CUSTOM_ID: make-every-terminal-workflow-advancement-complete-its-attributed-task
:END:
...
:PROPERTIES:
:CUSTOM_ID: persist-a-new-combined-aggregate-or-event
:END:
