...
:PROPERTIES:
:CUSTOM_ID: adr-0100-read-only-bounded-sparse-one-shot-schedule-due-cli-paging
:END:
- *Status:* accepted
- *Date:* 2026-08-08
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/1003][#1003]]
...
:PROPERTIES:
:CUSTOM_ID: add-paging-flags-to-schedule-due
:END:
...
:PROPERTIES:
:CUSTOM_ID: fill-a-dense-page-of-due-matches
:END:
