...
:PROPERTIES:
:CUSTOM_ID: adr-0045-durable-exact-finite-recurrence-occurrence-provenance
:END:
- *Status:* accepted
- *Date:* 2026-08-03
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/875][#875]]
...
:PROPERTIES:
:CUSTOM_ID: let-callers-assign-an-occurrence-id
:END:
...
:PROPERTIES:
:CUSTOM_ID: append-occurrences-to-the-recurrence-definition-stream
:END:
...
:PROPERTIES:
:CUSTOM_ID: materialize-directly-into-one-shot-schedules-or-tasks
:END:
...
:PROPERTIES:
:CUSTOM_ID: treat-duplicate-persistence-as-success
:END:
