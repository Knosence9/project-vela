...
:PROPERTIES:
:CUSTOM_ID: adr-0011-cancel-durable-workflow-runs-with-revision-bound-reason-events
:END:
- *Status:* accepted
- *Date:* 2026-07-28
...
:PROPERTIES:
:CUSTOM_ID: model-cancellation-as-a-workflow-transition
:END:
...
:PROPERTIES:
:CUSTOM_ID: allow-cancellation-after-terminal-arrival
:END:
...
:PROPERTIES:
:CUSTOM_ID: retry-after-optimistic-concurrency-conflicts
:END:
...
:PROPERTIES:
:CUSTOM_ID: store-only-a-cancelled-boolean
:END:
