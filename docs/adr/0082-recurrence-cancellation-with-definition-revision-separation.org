...
:PROPERTIES:
:CUSTOM_ID: adr-0082-recurrence-cancellation-with-definition-revision-separation
:END:
- *Status:* accepted
- *Date:* 2026-08-06
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/959][#959]]
...
:PROPERTIES:
:CUSTOM_ID: reuse-one-ambiguous-recurrence-revision
:END:
...
:PROPERTIES:
:CUSTOM_ID: model-cancellation-on-each-occurrence-stream
:END:
...
:PROPERTIES:
:CUSTOM_ID: allow-cancellation-to-block-release-or-claimed-materialization
:END:
...
:PROPERTIES:
:CUSTOM_ID: add-a-recurrence-cancel-cli-immediately
:END:
