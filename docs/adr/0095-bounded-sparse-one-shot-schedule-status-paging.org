...
:PROPERTIES:
:CUSTOM_ID: adr-0095-bounded-sparse-one-shot-schedule-status-paging
:END:
- *Status:* accepted
- *Date:* 2026-08-08
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/993][#993]]
...
:PROPERTIES:
:CUSTOM_ID: filter-schedulestorelist_page-results-in-each-caller
:END:
...
:PROPERTIES:
:CUSTOM_ID: fill-a-dense-page-of-matching-schedules
:END:
...
:PROPERTIES:
:CUSTOM_ID: change-schedulepage-cursor-semantics
:END:
