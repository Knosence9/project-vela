...
:PROPERTIES:
:CUSTOM_ID: adr-0024-preserve-explicit-workflow-phase-final-responses-as-task-failure-attempts
:END:
- *Status:* accepted
- *Date:* 2026-07-30
- *Decision issue:* [[https://github.com/Knosence9/project-vela/issues/756][#756]]
- *Execution issue:* [[https://github.com/Knosence9/project-vela/issues/757][#757]]
...
:PROPERTIES:
:CUSTOM_ID: derive-the-failure-diagnostic-from-the-provider-response
:END:
...
:PROPERTIES:
:CUSTOM_ID: fail-the-attributed-workflow-run-with-the-task
:END:
...
:PROPERTIES:
:CUSTOM_ID: persist-the-assistant-turn-attempt-and-failure-atomically
:END:
