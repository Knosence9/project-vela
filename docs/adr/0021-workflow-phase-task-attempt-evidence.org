...
:PROPERTIES:
:CUSTOM_ID: adr-0021-preserve-explicit-workflow-phase-responses-as-task-attempt-evidence
:END:
- *Status:* accepted
- *Date:* 2026-07-29
...
:PROPERTIES:
:CUSTOM_ID: accept-a-workflow-run-id-and-infer-its-task-and-current-phase
:END:
...
:PROPERTIES:
:CUSTOM_ID: store-a-new-workflow-phase-execution-event
:END:
...
:PROPERTIES:
:CUSTOM_ID: automatically-advance-or-complete-after-a-successful-response
:END:
