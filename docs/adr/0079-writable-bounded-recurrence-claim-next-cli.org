...
:PROPERTIES:
:CUSTOM_ID: adr-0079-writable-bounded-recurrence-claim-next-cli
:END:
- *Status:* accepted
- *Date:* 2026-08-06
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/953][#953]]
...
:PROPERTIES:
:CUSTOM_ID: compose-available-paging-and-exact-claim-in-the-cli
:END:
...
:PROPERTIES:
:CUSTOM_ID: read-ambient-time-or-persist-the-returned-cursor
:END:
