...
:PROPERTIES:
:CUSTOM_ID: adr-0026-preserve-explicit-workflow-phase-diagnoses-as-linked-task-evidence
:END:
- *Status:* accepted
- *Date:* 2026-07-30
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/763][#763]]
...
:PROPERTIES:
:CUSTOM_ID: record-the-diagnosis-as-another-attempt
:END:
...
:PROPERTIES:
:CUSTOM_ID: treat-the-response-as-verification-evidence
:END:
...
:PROPERTIES:
:CUSTOM_ID: append-the-assistant-turn-and-diagnostic-separately
:END:
