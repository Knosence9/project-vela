...
:PROPERTIES:
:CUSTOM_ID: adr-0066-atomic-bounded-due-recurrence-task-materialization
:END:
- *Status:* accepted
- *Date:* 2026-08-05
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/925][#925]]
...
:PROPERTIES:
:CUSTOM_ID: persist-the-page-then-materialize-each-coordinate
:END:
...
:PROPERTIES:
:CUSTOM_ID: skip-existing-provenance-or-task-identities
:END:
...
:PROPERTIES:
:CUSTOM_ID: generate-task-identities
:END:
