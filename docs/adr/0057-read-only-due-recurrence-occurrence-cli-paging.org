...
:PROPERTIES:
:CUSTOM_ID: adr-0057-read-only-due-recurrence-occurrence-cli-paging
:END:
- *Status:* accepted
- *Date:* 2026-08-04
...
:PROPERTIES:
:CUSTOM_ID: read-the-system-clock-in-the-cli
:END:
...
:PROPERTIES:
:CUSTOM_ID: select-due-occurrences-across-every-recurrence
:END:
...
:PROPERTIES:
:CUSTOM_ID: persist-the-returned-cursor-automatically
:END:
