...
:PROPERTIES:
:CUSTOM_ID: adr-0002-persist-typed-events-in-a-local-sqlite-log
:END:
- *Status:* accepted
- *Date:* 2026-07-13
- *Owners:* Project Vela maintainers
- *Related issue:* [[https://github.com/Knosence9/project-vela/issues/342][#342]]
- *Related pull request:* [[https://github.com/Knosence9/project-vela/pull/345][#345]]
...
:PROPERTIES:
:CUSTOM_ID: rich-envelope-and-batch-appends
:END:
