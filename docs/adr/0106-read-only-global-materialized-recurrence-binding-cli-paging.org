...
:PROPERTIES:
:CUSTOM_ID: adr-0106-read-only-global-materialized-recurrence-binding-cli-paging
:END:
- *Status:* accepted
- *Date:* 2026-08-08
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/1019][#1019]]
...
:PROPERTIES:
:CUSTOM_ID: serialize-the-internal-stream-key
:END:
...
:PROPERTIES:
:CUSTOM_ID: encode-the-cursor-as-one-delimiter-separated-string
:END:
...
:PROPERTIES:
:CUSTOM_ID: allow-either-cursor-field-independently
:END:
