...
:PROPERTIES:
:CUSTOM_ID: adr-0060-explicit-latest-only-finite-recurrence-catch-up-selection
:END:
- *Status:* accepted
- *Date:* 2026-08-04
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/913][#913]]
...
:PROPERTIES:
:CUSTOM_ID: add-a-generic-catch-up-policy-enum-now
:END:
...
:PROPERTIES:
:CUSTOM_ID: page-all-due-occurrences-and-retain-the-final-result
:END:
...
:PROPERTIES:
:CUSTOM_ID: persist-skipped-coordinate-evidence-automatically
:END:
...
:PROPERTIES:
:CUSTOM_ID: read-the-current-clock-inside-the-store
:END:
