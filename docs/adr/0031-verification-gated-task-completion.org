...
:PROPERTIES:
:CUSTOM_ID: adr-0031-complete-tasks-through-caller-owned-verification-gates
:END:
- *Status:* accepted
- *Date:* 2026-07-30
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/775][#775]]
...
:PROPERTIES:
:CUSTOM_ID: let-callers-evaluate-then-call-unconditional-completion
:END:
...
:PROPERTIES:
:CUSTOM_ID: make-every-completion-verification-gated
:END:
...
:PROPERTIES:
:CUSTOM_ID: persist-required-gates-before-completion
:END:
...
:PROPERTIES:
:CUSTOM_ID: fail-immediately-on-any-concurrent-task-event
:END:
