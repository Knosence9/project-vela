...
:PROPERTIES:
:CUSTOM_ID: adr-0094-read-only-bounded-one-shot-schedule-inventory-cli-paging
:END:
- *Status:* accepted
- *Date:* 2026-08-07
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/989][#989]]
...
:PROPERTIES:
:CUSTOM_ID: add-paging-flags-to-schedule-inspect
:END:
...
:PROPERTIES:
:CUSTOM_ID: add-lifecycle-or-due-filtering
:END:
