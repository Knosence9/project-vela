...
:PROPERTIES:
:CUSTOM_ID: adr-0112-bounded-native-emacs-project-context
:END:
- *Status:* accepted
- *Date:* 2026-08-08
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/1035][#1035]]
- *Related:* [[file:0108-main-thread-authoritative-emacs-agent-interface.org][ADR-0108]], [[file:0111-process-local-live-emacs-buffer-identity.org][ADR-0111]]
...
:PROPERTIES:
:CUSTOM_ID: infer-a-project-from-the-visited-file
:END:
...
:PROPERTIES:
:CUSTOM_ID: return-project-files-or-backend-specific-metadata
:END:
...
:PROPERTIES:
:CUSTOM_ID: resolve-the-project-outside-emacs
:END:
