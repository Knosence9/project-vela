...
:PROPERTIES:
:CUSTOM_ID: adr-0001-keep-secret-declarations-in-git-and-values-in-external-providers
:END:
- *Status:* Accepted
- *Date:* 2026-07-12
- *Issue:* [[https://github.com/Knosence9/project-vela/issues/343][#343]]
- *Source:* [[https://www.youtube.com/watch?v=dII4uMU-5R8][SecretSpec overview]]
...
:CUSTOM_ID: decision
:END:
Use [[https://secretspec.dev/][SecretSpec]] as the developer-facing boundary
...
:PROPERTIES:
:CUSTOM_ID: reimplement-secret-storage-in-vela
:END:
...
:PROPERTIES:
:CUSTOM_ID: continue-with-env-files
:END:
...
:PROPERTIES:
:CUSTOM_ID: couple-vela-dev-to-the-secretspec-rust-sdk-now
:END:
