...
:PROPERTIES:
:CUSTOM_ID: adr-0108-main-thread-authoritative-emacs-agent-interface
:END:
- *Status:* accepted
- *Date:* 2026-08-08
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/1025][#1025]]
- *Related:* [[file:0107-bounded-python-adapter-execution.org][ADR-0107]]
...
:PROPERTIES:
:CUSTOM_ID: run-the-model-or-agent-loop-inside-emacs
:END:
...
:PROPERTIES:
:CUSTOM_ID: drive-emacs-primarily-with-synthesized-keys
:END:
...
:PROPERTIES:
:CUSTOM_ID: expose-arbitrary-eval
:END:
...
:PROPERTIES:
:CUSTOM_ID: parse-org-only-outside-emacs
:END:
