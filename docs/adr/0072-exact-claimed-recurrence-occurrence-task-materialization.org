...
:PROPERTIES:
:CUSTOM_ID: adr-0072-exact-claimed-recurrence-occurrence-task-materialization
:END:
- *Status:* accepted
- *Date:* 2026-08-05
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/939][#939]]
...
:PROPERTIES:
:CUSTOM_ID: broaden-materialize_occurrence
:END:
...
:PROPERTIES:
:CUSTOM_ID: release-before-every-materialization
:END:
...
:PROPERTIES:
:CUSTOM_ID: add-task-identity-to-the-claim
:END:
