...
:PROPERTIES:
:CUSTOM_ID: adr-0111-process-local-live-emacs-buffer-identity
:END:
- *Status:* accepted
- *Date:* 2026-08-08
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/1033][#1033]]
- *Related:* [[file:0108-main-thread-authoritative-emacs-agent-interface.org][ADR-0108]], [[file:0110-observational-emacs-buffer-text-revision.org][ADR-0110]]
...
:PROPERTIES:
:CUSTOM_ID: expose-sxhash-eq-of-the-buffer-object
:END:
...
:PROPERTIES:
:CUSTOM_ID: store-a-uuid-in-a-buffer-local-variable
:END:
