...
:PROPERTIES:
:CUSTOM_ID: adr-0037-durable-finite-fixed-interval-recurrence-definitions
:END:
- *Status:* accepted
- *Date:* 2026-08-02
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/859][#859]]
...
:PROPERTIES:
:CUSTOM_ID: persist-an-unbounded-recurrence
:END:
...
:PROPERTIES:
:CUSTOM_ID: reuse-one-shot-schedule-identities-and-streams
:END:
...
:PROPERTIES:
:CUSTOM_ID: generate-occurrences-in-the-creation-slice
:END:
