...
:PROPERTIES:
:CUSTOM_ID: adr-0005-require-caller-owned-skill-registration-and-explicit-prompt-composition
:END:
- *Status:* accepted
- *Date:* 2026-07-27
- *Owners:* Project Vela maintainers
- *Related issues:* [[https://github.com/Knosence9/project-vela/issues/654][#654]], [[https://github.com/Knosence9/project-vela/issues/659][#659]]
- *First execution issue:* [[https://github.com/Knosence9/project-vela/issues/655][#655]]
- *Composed tool execution issue:* [[https://github.com/Knosence9/project-vela/issues/660][#660]]
- *Durable composed attempt issue:* [[https://github.com/Knosence9/project-vela/issues/664][#664]]
- *Durable composed correction issue:* [[https://github.com/Knosence9/project-vela/issues/666][#666]]
- *Durable composed completion issue:* [[https://github.com/Knosence9/project-vela/issues/668][#668]]
- *Durable composed failure issue:* [[https://github.com/Knosence9/project-vela/issues/670][#670]]
- *Durable composed cancellation issue:* [[https://github.com/Knosence9/project-vela/issues/672][#672]]
...
:PROPERTIES:
:CUSTOM_ID: treat-prepared-artifacts-as-the-registry
:END:
...
:PROPERTIES:
:CUSTOM_ID: automatically-include-every-registered-skill
:END:
...
:PROPERTIES:
:CUSTOM_ID: concatenate-instruction-strings-in-the-runtime
:END:
...
:PROPERTIES:
:CUSTOM_ID: add-persistence-precedence-and-token-budgeting-now
:END:
