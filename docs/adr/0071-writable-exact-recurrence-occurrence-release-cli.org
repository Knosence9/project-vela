...
:PROPERTIES:
:CUSTOM_ID: adr-0071-writable-exact-recurrence-occurrence-release-cli
:END:
- *Status:* accepted
- *Date:* 2026-08-05
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/937][#937]]
...
:PROPERTIES:
:CUSTOM_ID: infer-recovery-from-elapsed-time
:END:
...
:PROPERTIES:
:CUSTOM_ID: release-without-an-exact-observed-revision
:END:
...
:PROPERTIES:
:CUSTOM_ID: combine-claim-and-release
:END:
