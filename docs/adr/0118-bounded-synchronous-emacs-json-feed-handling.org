...
:PROPERTIES:
:CUSTOM_ID: adr-0118-bounded-synchronous-emacs-json-feed-handling
:END:
- *Status:* accepted
- *Date:* 2026-08-09
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/1051][#1051]]
- *Related:* [[file:0115-bounded-in-process-emacs-json-adapter.org][ADR-0115]], [[file:0116-bounded-newline-delimited-emacs-json-framing.org][ADR-0116]], [[file:0117-bounded-outbound-emacs-json-framing.org][ADR-0117]]
...
:PROPERTIES:
:CUSTOM_ID: let-every-transport-compose-the-three-helpers
:END:
...
:PROPERTIES:
:CUSTOM_ID: return-successful-responses-before-a-later-request-fails
:END:
...
:PROPERTIES:
:CUSTOM_ID: open-a-local-socket-or-child-process-now
:END:
