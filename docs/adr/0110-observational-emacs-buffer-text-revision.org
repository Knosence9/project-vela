...
:PROPERTIES:
:CUSTOM_ID: adr-0110-observational-emacs-buffer-text-revision
:END:
- *Status:* accepted
- *Date:* 2026-08-08
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/1029][#1029]]
...
:PROPERTIES:
:CUSTOM_ID: return-buffer-modified-p-only
:END:
...
:PROPERTIES:
:CUSTOM_ID: hash-the-entire-accessible-buffer
:END:
...
:PROPERTIES:
:CUSTOM_ID: add-a-writable-operation-with-the-tick
:END:
