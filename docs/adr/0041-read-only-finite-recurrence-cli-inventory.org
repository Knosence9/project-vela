...
:PROPERTIES:
:CUSTOM_ID: adr-0041-read-only-finite-recurrence-cli-inventory
:END:
- *Status:* accepted
- *Date:* 2026-08-02
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/867][#867]]
...
:PROPERTIES:
:CUSTOM_ID: add-writable-recurrence-creation
:END:
...
:PROPERTIES:
:CUSTOM_ID: include-projected-occurrences
:END:
...
:PROPERTIES:
:CUSTOM_ID: reimplement-discovery-in-the-cli
:END:
