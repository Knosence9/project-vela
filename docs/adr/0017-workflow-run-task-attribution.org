...
:PROPERTIES:
:CUSTOM_ID: adr-0017-attribute-workflow-run-starts-immutably-to-active-tasks
:END:
- *Status:* accepted
- *Date:* 2026-07-28
...
:PROPERTIES:
:CUSTOM_ID: store-attribution-in-a-later-association-event
:END:
...
:PROPERTIES:
:CUSTOM_ID: accept-a-task-id-without-validating-the-task
:END:
...
:PROPERTIES:
:CUSTOM_ID: automatically-synchronize-terminal-states
:END:
