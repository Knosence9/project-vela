...
:PROPERTIES:
:CUSTOM_ID: adr-0040-read-only-finite-recurrence-inventory
:END:
- *Status:* accepted
- *Date:* 2026-08-02
- *Decision and execution issue:* [[https://github.com/Knosence9/project-vela/issues/865][#865]]
...
:PROPERTIES:
:CUSTOM_ID: add-the-recurrence-cli-first
:END:
...
:PROPERTIES:
:CUSTOM_ID: discover-streams-by-prefix-alone
:END:
...
:PROPERTIES:
:CUSTOM_ID: skip-malformed-definitions
:END:
