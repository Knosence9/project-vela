...
- backend capability comparisons that clarify promotion criteria through recorded pass/fail outcomes, visible provider capability summaries, and a separate reviewed routing slice before runtime promotion
