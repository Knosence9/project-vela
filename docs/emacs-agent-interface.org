...
current buffer derives from =magit-mode=. A recognized buffer reports only the
bounded exact =major_mode= symbol name. This classifies already-loaded current
Magit buffers without loading Magit, calling Git, resolving or selecting a
