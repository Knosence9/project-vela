...
:PROPERTIES:
:CUSTOM_ID: tool-invocation-and-permission-boundary
:END:
...
:PROPERTIES:
:CUSTOM_ID: effects-and-permission-scope
:END:
...
:PROPERTIES:
:CUSTOM_ID: ordering-and-failures
:END:
...
:PROPERTIES:
:CUSTOM_ID: bounded-provider-tool-step
:END:
...
:PROPERTIES:
:CUSTOM_ID: durable-invocation-evidence
:END:
...
:PROPERTIES:
:CUSTOM_ID: crash-and-append-semantics
:END:
